...
export class DefaultService {
  ...
  public apiV1OrdersGet(
    ...
    sellToken?: string,
    buyToken?: string,
    includeFullyExecuted?: boolean,
    includeInvalidated?: boolean,
    includeInsufficientBalance?: boolean,
    minValidTo?: number,
  ): Observable<AxiosResponse<Array<Order>>>;
  public apiV1OrdersGet(
    owner?: string,
    sellToken?: string,
    buyToken?: string,
  ...
  public apiV1OrdersPost(body: OrderCreation): Observable<any> {
    if (body === null || body === undefined) {
      throw new Error(
        'Required parameter body was null or undefined when calling apiV1OrdersPost.',
      );
    }
    ...
    return this.httpClient.post<string>(`${this.basePath}/api/v1/orders`, body, {
      withCredentials: this.configuration.withCredentials,
      headers: headers,
    });
  }
  ...
  public apiV1OrdersUIDDelete(uID: string, body: OrderCancellation): Observable<any> {
    if (uID === null || uID === undefined) {
      throw new Error(
        'Required parameter uID was null or undefined when calling apiV1OrdersUIDDelete.',
      );
    }

    if (body === null || body === undefined) {
      throw new Error(
        'Required parameter body was null or undefined when calling apiV1OrdersUIDDelete.',
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/api/v1/orders/${encodeURIComponent(String(UID))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
      },
  ...
  public apiV1OrdersUIDGet(uID: string): Observable<any> {
    if (uID === null || uID === undefined) {
      throw new Error(
        'Required parameter uID was null or undefined when calling apiV1OrdersUIDGet.',
      );
    }
  ...
  public apiV1TokensSellTokenFeeGet(sellToken: string): Observable<any> {
    if (sellToken === null || sellToken === undefined) {
      throw new Error(
        'Required parameter sellToken was null or undefined when calling apiV1TokensSellTokenFeeGet.',
      );
    }
    ...
    // to determine the Content-Type header
    const consumes: string[] = [];
    return this.httpClient.get<FeeInformation>(
      `${this.basePath}/api/v1/tokens/${encodeURIComponent(String(sellToken))}/fee`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
      },
